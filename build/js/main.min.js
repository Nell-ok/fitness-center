...
var priceButtons = document.querySelectorAll('.tabs__link');
var priceCards = document.querySelectorAll('.price__list');
var sliderCoaches = document.querySelector('.slider');
var prevButtonCoaches = document.querySelector('.coaches__button-left');
var nextButtonCoaches = document.querySelector('.coaches__button-right');
var sliderFeedback = document.querySelector('.feedback__slider');
var prevButtonFeedback = document.querySelector('.feedback__button-left');
var nextButtonFeedback = document.querySelector('.feedback__button-right');
var isPriceElements = priceButtons && priceCards;
var isCoachesElements = sliderCoaches && prevButtonCoaches && nextButtonCoaches;
var isFeedbackElements = sliderFeedback && prevButtonFeedback && nextButtonFeedback;

var activatePrice = function activatePrice() {
...
var showCards = function showCards(index) {
  priceButtons.forEach(function (tab) {
...
var onClickTab = function onClickTab(tab, index) {
...
var selectPriceButtons = function selectPriceButtons() {
...
var onClickPrevButton = function onClickPrevButton(button, swiper) {
  button.addEventListener('click', function () {
    swiper.slidePrev();
  });
};

var onClickNextButton = function onClickNextButton(button, swiper) {
  button.addEventListener('click', function () {
    swiper.slideNext();
  });
};
...
if (isCoachesElements) {
  var swiperCoaches = new _vendor__WEBPACK_IMPORTED_MODULE_0___default.a(sliderCoaches, {
    loop: true,
    navigation: {
...
if (isFeedbackElements) {
  var swiperFeedback = new _vendor__WEBPACK_IMPORTED_MODULE_0___default.a(sliderFeedback, {
    slidesPerView: 1,
    spaceBetween: 0,
    simulateTouch: false,
    navigation: {
